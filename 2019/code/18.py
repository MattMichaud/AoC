...
def get_grid(filename, part_b=False):
...
filename = '2019/inputs/18.txt'

grid, keys, doors, start_points, max_x, max_y = get_grid(filename)
min_length, counter = find_smallest_path(grid, keys, doors, start_points, max_x, max_y)
print(f'Part 1 Answer: {min_length}')

grid, keys, doors, start_points, max_x, max_y = get_grid(filename, part_b=True)
min_length, counter = find_smallest_path(grid, keys, doors, start_points, max_x, max_y)
print(f'Part 2 Answer: {min_length}')